...
export default function CompanyLogo({ company, size = 'md' }) {
  ...
  const borderRadius = size === 'lg' ? '50%' : '0px';
  ...
  const hasHardcodedLogo = logos[logoKey];

  // Try to use clearbit as primary source for "original" logos
  const clearbitUrl = `https://logo.clearbit.com/${logoKey}.com`;
